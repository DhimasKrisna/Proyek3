<div class="container">
    ...
    ?>
        <div class="row mb-3">
            <div class="col">
                <a href="<?= base_url('user/tambah_politik') ?>" class="btn btn-success">Tambah Data</a>
            </div>
        </div>
    <?php
    }
                                    ...
                                    ?>
                                        <td>
                                            <?php if ($this->session->userdata('kec') == $row->kecamatan) { ?>
                                                <a href="<?= base_url('user/edit_politik?id=' . $row->id) ?>" class="btn btn-primary">Sunting</a>
                                                <a href="<?= base_url('user/hapus_politik?id=' . $row->id) ?>" class="btn btn-danger">Hapus</a>
                                            <?php } else { ?>
